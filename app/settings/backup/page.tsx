    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <div className="border-b border-stone-200 pb-4">
        <h1 className="text-xl sm:text-2xl font-black font-devanagari text-stone-900 flex items-center gap-2">
          ...
          <span>डेटा बॅकअप व चाचणी डेटा व्यवस्थापन (Backup & Reset)</span>
        </h1>
        <p className="text-xs text-stone-500 font-devanagari">
          मंडळाचा संपूर्ण डेटा एका क्लिकवर डाऊनलोड करा, रिस्टोअर करा किंवा चाचणी (Test) डेटा पूर्णपणे स्वच्छ करा.
        </p>
      </div>
      ...
      {/* 3. CRITICAL: CLEAR ALL TEST DATA */}
      <Card className="border-red-300 bg-red-50/40 shadow-sm">
        <CardHeader className="bg-red-100/60">
          ...
          <CardDescription className="text-xs text-red-800 font-devanagari">
            विकास किंवा चाचणी दरम्यान तयार केलेला सर्व खोटा (Test) डेटा एका क्लिकवर नष्ट करा. मूळ (Live) डेटा १००% सुरक्षित राहील.
          </CardDescription>
        </CardHeader>
        <CardContent className="p-6 space-y-3">
      ...
      <Modal
        ...
        maxWidth="md"
      >
        <form onSubmit={handleClearTestData} className="space-y-4">
          {clearError && (
          ...
          <div className="p-3.5 bg-stone-100 rounded-xl text-xs text-stone-700 font-devanagari space-y-1">
            ...
            <div className="font-mono font-bold text-red-700 bg-white p-2 rounded border border-stone-300 select-all">
              CLEAR_ALL_TEST_DATA
            </div>
          </div>
          ...
          <div className="space-y-1">
            <input
              ...
              className="w-full px-3.5 py-2.5 border-2 border-red-400 rounded-lg text-xs font-mono font-bold focus:ring-2 focus:ring-red-500"
            />
          </div>
